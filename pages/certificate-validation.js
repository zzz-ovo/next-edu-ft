        ...
        verifyRes === "success" ?
          <>
            ...
            <div style={{ position: "relative" }}>
              ...
              <span style={{ position: "absolute", color: "rgb(147,143,143)", bottom: 80, fontSize: "10px", left: "11%", transform: "translateX(-50%)" }}>#{formatData[2][0][1] - 2}</span>
              <span style={{ position: "absolute", color: "rgb(147,143,143)", bottom: 80, fontSize: "10px", left: "30.5%", transform: "translateX(-50%)" }}>#{formatData[2][0][1] - 1}</span>
              <span style={{ position: "absolute", color: "rgb(147,143,143)", bottom: 80, fontSize: "10px", left: "50%", transform: "translateX(-50%)" }}>#{formatData[2][0][1]}</span>
              <span style={{ position: "absolute", color: "rgb(147,143,143)", bottom: 80, fontSize: "10px", left: "69.5%", transform: "translateX(-50%)" }}>#{formatData[2][0][1] + 1}</span>
              <span style={{ position: "absolute", color: "rgb(147,143,143)", bottom: 80, fontSize: "10px", left: "89%", transform: "translateX(-50%)" }}>#{formatData[2][0][1] + 2}</span>
            </div>
          </>
          :
          <div style={{ paddingLeft: 10, paddingRight: 10 }}>
